...
export const PDFPreviewModal: React.FC<PDFPreviewModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-slate-900/40 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white border border-slate-200 rounded-3xl max-w-4xl w-full max-h-[94vh] flex flex-col shadow-2xl overflow-hidden transition-colors">
        {/* Modal Top Bar */}
        <div className="px-6 py-3.5 bg-blue-900 text-white flex items-center justify-between gap-3 border-b border-blue-950 flex-wrap">
          <div className="flex items-center gap-2.5">
            <div className="p-1.5 rounded-lg bg-emerald-600 text-white">
              <FileText className="w-4 h-4" />
            </div>
            <div>
              <span className="text-xs font-mono text-emerald-300 font-bold uppercase tracking-wider block leading-none">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold transition-all cursor-pointer border ${
                isEditing
                  ...
                  : 'bg-blue-800 hover:bg-blue-700 text-amber-300 border-blue-700'
              }`}
            ...
            <button
              onClick={handlePrint}
              className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-blue-800 hover:bg-blue-700 text-slate-100 text-xs font-bold transition-colors cursor-pointer border border-blue-700"
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-4 py-1.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 disabled:bg-slate-400 text-white text-xs font-black transition-all cursor-pointer shadow-md"
            >
            ...
            <button
              onClick={onClose}
              className="p-1.5 rounded-xl bg-blue-800 hover:bg-red-600 text-white transition-colors cursor-pointer"
            >
              <X className="w-4 h-4" />
            </button>
          </div>
        ...
        {/* ========================================================================= */}
        {isEditing && (
          <div className="p-4 sm:p-5 bg-amber-50 border-b border-amber-200 animate-in slide-in-from-top-2 duration-200 overflow-y-auto max-h-[38vh]">
              ...
              <div className="flex items-center justify-between pb-2 border-b border-amber-200">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="px-2.5 py-1 rounded-lg bg-slate-200 text-slate-700 text-xs font-bold hover:bg-slate-300 cursor-pointer flex items-center gap-1"
                  >
                  ...
                  <button
                    ...
                    className="px-3.5 py-1 rounded-lg bg-emerald-600 text-white text-xs font-bold hover:bg-emerald-700 cursor-pointer flex items-center gap-1 shadow-xs"
                  >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
                ...
                <div className="sm:col-span-2">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-1.5 rounded-xl border border-slate-300 bg-white font-semibold text-slate-900 focus:ring-2 focus:ring-emerald-500"
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className="w-1/2 px-3 py-1.5 rounded-xl border border-slate-300 bg-white font-mono text-center text-slate-900"
                    />
                    <input
                      type="text"
                      placeholder="YYYY"
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-1.5 rounded-xl border border-slate-300 bg-white font-mono font-bold text-amber-700"
                  />
                </div>
              </div>
            </div>
        ...
        <div className="flex-1 overflow-y-auto p-6 sm:p-8 bg-slate-100 text-slate-900 space-y-6">
          ...
          <div className="max-w-3xl mx-auto bg-white border border-slate-200 rounded-2xl p-6 sm:p-8 shadow-sm space-y-6">
            ...
            <div className="text-center border-b-2 border-slate-900 pb-5 space-y-1">
              ...
              <div className="inline-block mt-1 px-3 py-0.5 rounded-full bg-slate-100 border border-slate-200 text-[11px] font-mono font-bold text-slate-700">
            ...
            <div className="border border-slate-200 rounded-xl p-4 space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
                <div>
                  <span className="text-[10px] text-slate-500 block">Commodity Commercial Title:</span>
                  <span className="font-black text-slate-900 text-sm">{p.productName || 'Packaged Commodity'}</span>
                </div>
                <div>
                  <span className="text-[10px] text-slate-500 block">Brand / Marketer:</span>
                  <span className="font-bold text-slate-800">{p.brandName || 'N/A'}</span>
                </div>
                <div>
                  <span className="text-[10px] text-slate-500 block">Country of Origin:</span>
                  <span className="font-bold text-slate-800">{p.countryOfOrigin || 'India'}</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 pt-2 border-t border-slate-100 text-xs">
                ...
                <div>
                  <span className="text-[10px] text-slate-500 block">Retail Sale Price (MRP):</span>
                  <span className="font-mono font-bold text-slate-900">
                    {p.mrpString || `₹${p.mrp || 0}`}
                  </span>
                </div>
                <div>
                  <span className="text-[10px] text-slate-500 block">Mfg Date:</span>
                  <span className="font-mono font-bold text-slate-900">
              ...
              <div className="text-xs pt-2 border-t border-slate-100">
                <span className="text-[10px] text-slate-500 block">Manufacturer / Packer Identity & Premises:</span>
                  ...
                  <tbody className="divide-y divide-slate-100">
                    {reportData.evaluations.map((ev, idx) => (
                      <tr key={idx} className="hover:bg-slate-50">
                        ...
                        <td className="p-2.5 text-slate-800 font-mono text-[11px]">
            ...
            <div className="pt-8 grid grid-cols-2 gap-8 border-t border-slate-200 text-xs text-center">
              <div>
                ...
                <span className="font-bold text-slate-700 block mt-1">Authorized Legal Metrology Officer</span>
              ...
              <div>
                ...
                <span className="font-bold text-slate-700 block mt-1">Responsible Person / Packer Representative</span>
