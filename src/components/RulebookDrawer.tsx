          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4 text-xs">
            ...
            {onOpenCloudModal && (
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-slate-100 hover:bg-slate-200 text-slate-800 py-2 rounded-xl font-bold transition-all cursor-pointer"
              >
                <Cloud className="w-4 h-4 text-[#0A3663]" />
                <span>View Live Cloud Database Status</span>
              </button>
            )}
          </div>
        )}
