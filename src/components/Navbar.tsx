...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <header className="sticky top-0 z-40 bg-white border-b border-slate-200 shadow-xs transition-colors">
      {/* Top Govt of India & SIH Strip */}
      <div className="bg-slate-100 text-slate-700 px-4 py-1.5 text-[11px] border-b border-slate-200 flex flex-wrap items-center justify-between gap-2">
        <div className="flex items-center gap-2">
          <span className="inline-block w-2 h-2 rounded-full bg-blue-600 animate-pulse"></span>
          <span className="font-extrabold text-slate-900 tracking-wide">SMART INDIA HACKATHON 2026</span>
          <span className="text-slate-400">•</span>
          <span className="font-mono font-bold bg-white px-2 py-0.5 rounded text-slate-800 border border-slate-200">PS ID: SIH-26034</span>
        ...
        <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
          ...
          <div className="flex items-center rounded-lg bg-white p-0.5 border border-slate-200 text-[10px] font-bold">
            <Globe className="w-3 h-3 text-blue-600 ml-1 mr-1" />
          ...
          <div className="hidden lg:flex items-center gap-1 text-slate-700 font-bold">
            <CheckCircle className="w-3 h-3 text-blue-600" />
            <span>LMPC Rules 2011</span>
          </div>
          <span className="hidden lg:inline text-slate-300">|</span>
          <div className="hidden lg:block text-slate-800 font-mono font-bold">Team: Neural Knights</div>
        </div>
      </div>

      {/* Main Navbar - Single Minimal Line Layout */}
        ...
        <div className="flex items-center gap-2.5 shrink-0">
          ...
          <div className="relative">
            <button
              ...
              className="p-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 transition-all cursor-pointer border border-slate-200 shadow-xs flex items-center justify-center"
              title="Quick Menu"
            >
              {isMenuOpen ? (
                ...
                <div className="absolute left-0 mt-2 w-72 bg-white rounded-2xl shadow-xl border border-slate-200 py-2 z-50 animate-in fade-in zoom-in-95 duration-150">
                  ...
                  {currentUser ? (
                    ...
                    <div className="px-4 py-2.5 border-b border-slate-200 bg-slate-50">
                      ...
                      <button
                        ...
                        className="text-[11px] font-bold text-blue-600 hover:underline cursor-pointer mt-0.5 block"
                      >
                  ...
                  <div className="py-1">
                    <button
                      ...
                      className="w-full px-4 py-2 text-left text-xs font-bold text-slate-700 hover:bg-slate-100 flex items-center gap-3 transition-colors cursor-pointer"
                    >
                      <Home className="w-4 h-4 text-blue-600 shrink-0" />
                      <div>
                        <div>{getTranslation('tab_home', currentLang)}</div>
                        <div className="text-[10px] font-normal text-slate-500">Main welcome and gateway dashboard</div>
                      </div>
                    </button>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="text-[10px] font-normal text-slate-500">Official credentials, jurisdiction & powers</div>
                      </div>
                    </button>
                    ...
                    >
                      ...
                      <div>
                        <div>{getTranslation('tab_vault', currentLang)}</div>
                        <div className="text-[10px] font-normal text-slate-500">Historical inspections & statutory evidence</div>
                      </div>
                    </button>
                    ...
                    >
                      ...
                      <div>
                        <div>{getTranslation('tab_rulebook', currentLang)}</div>
                        <div className="text-[10px] font-normal text-slate-500">Full 43-page official Gazette notifications</div>
                      </div>
                    </button>
                    ...
                    >
                      ...
                      <div>
                        <div>{getTranslation('tab_grievance', currentLang)}</div>
                        <div className="text-[10px] font-normal text-slate-500">Consumer helpline 1915 direct portal</div>
                      </div>
                    </button>
                  </div>
                  ...
                  <div className="border-t border-slate-200 pt-1 mt-1">
                    {currentUser ? (
                      ...
                      <button
                        ...
                        className="w-full px-4 py-2 text-left text-xs font-bold text-blue-600 hover:bg-blue-50 flex items-center gap-3 transition-colors cursor-pointer"
                      >
          ...
          >
            <img
              ...
              alt="Inspack Logo"
              className="h-8 w-auto object-contain rounded-md border border-slate-200"
              onError={(e) => {
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[8.5px] uppercase tracking-wider text-blue-600 font-extrabold mt-0.5 truncate max-w-[150px]">
                {getRoleSubtitle()}
              </span>
            </div>
          </div>
          ...
          {currentUser ? (
            <div className="relative">
              <button
                ...
                className="flex items-center gap-2 px-3 py-1.5 bg-slate-100 hover:bg-slate-200/80 border border-slate-200 rounded-xl text-xs font-semibold text-slate-800 transition-all cursor-pointer shadow-xs"
              ...
              >
                ...
                <div className="flex flex-col text-left leading-tight">
                  <span className="text-[11px] font-bold text-slate-800 truncate max-w-[85px] sm:max-w-[110px]">
                    {currentUser.name.split(' ')[0]}
                  </span>
                  <span className="text-[8.5px] font-extrabold text-blue-600 uppercase tracking-wider">
                    {userRole}
                  </span>
                </div>
                <ChevronDown className={`w-3.5 h-3.5 text-slate-500 transition-transform duration-150 ${isUserDropdownOpen ? 'rotate-180' : ''}`} />
              </button>
                ...
                <div className="absolute right-0 mt-2 w-64 bg-white rounded-2xl shadow-xl border border-slate-200 py-2 z-50 animate-in fade-in zoom-in-95 duration-150">
                  ...
                  <div className="px-4 py-2.5 border-b border-slate-100 bg-slate-50">
                    ...
                    <div className="mt-1 flex items-center gap-1.5">
                      <span className="text-[9px] font-extrabold px-2 py-0.5 rounded-full bg-blue-50 text-blue-700 border border-blue-100 uppercase">
                        {userRole}
                      </span>
                  ...
                  <div className="border-t border-slate-100 pt-1 mt-1">
                    <button
                      ...
                      className="w-full px-4 py-2 text-left text-xs font-medium text-rose-600 hover:bg-rose-50 flex items-center gap-2.5 transition-colors cursor-pointer"
                    >
            ...
            <button
              onClick={onOpenLogin}
              className="flex items-center gap-1.5 px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-xs font-semibold transition-all cursor-pointer shadow-xs"
            >
