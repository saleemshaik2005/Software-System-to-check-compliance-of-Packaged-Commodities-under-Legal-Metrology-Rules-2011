...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-[#FAEDCD]/70 border-t border-[#DDBEA9] text-[#6B705C] py-8 px-4 text-xs mt-12 transition-colors">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 items-center justify-between">
        {/* Brand & Mission */}
        <div>
          <div className="flex items-center gap-2 mb-1.5">
            <span className="text-xl font-black tracking-tight text-[#6B705C]">
              in<span className="text-[#D4A373]">spack</span>
            </span>
            <span className="text-[10px] bg-[#CCD5AE] text-[#6B705C] border border-[#B7B7A4] px-2 py-0.5 rounded-full font-bold">
              SIH-26034
            </span>
          </div>
          <p className="text-[#A5A58D] leading-relaxed text-[11px]">
        ...
        <div className="text-left md:text-center space-y-2">
          <div className="text-[#6B705C] font-black uppercase tracking-wider text-xs flex items-center justify-start md:justify-center gap-1.5">
          ...
          <div className="flex items-center justify-start md:justify-center gap-3 pt-1">
            <a
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-white hover:bg-[#E9EDC9] text-[#6B705C] font-bold text-xs transition-colors border border-[#DDBEA9] cursor-pointer shadow-2xs"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-white hover:bg-[#E9EDC9] text-[#CB997E] font-bold text-xs transition-colors border border-[#DDBEA9] cursor-pointer shadow-2xs"
            >
              <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
        ...
        <div className="text-left md:text-right text-[10px] text-[#A5A58D] space-y-1">
          <div>Conforms to Legal Metrology Act, 2009 (Act No. 1 of 2010)</div>
          <div>Gazette Notification GSR 202(E) & GSR 748(E)</div>
          <div className="text-[#6B705C] font-bold">100% Free Open-Source Architecture</div>
        </div>
      </div>
    </footer>
  );
