...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-white border-t border-slate-200 text-slate-600 py-8 px-4 text-xs mt-12 transition-colors">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 items-center justify-between">
        ...
        <div className="text-left md:text-center space-y-2">
          <div className="text-slate-800 font-bold uppercase tracking-wider text-xs flex items-center justify-start md:justify-center gap-1.5">
          ...
          <div className="flex items-center justify-start md:justify-center gap-3 pt-1">
            <a
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-50 hover:bg-slate-100 text-slate-700 font-semibold text-xs transition-colors border border-slate-200 cursor-pointer shadow-2xs"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-50 hover:bg-slate-100 text-blue-600 font-semibold text-xs transition-colors border border-slate-200 cursor-pointer shadow-2xs"
            >
              <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
        ...
        <div className="text-left md:text-right text-[10px] text-slate-400 space-y-1">
